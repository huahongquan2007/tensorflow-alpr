...
def get_training_model():
    ...
    # Output layer
    W_fc2 = weight_variable([2048, 1 + MAX_CHARS * len(common.CHARS)])
    b_fc2 = bias_variable([1 + MAX_CHARS* len(common.CHARS)])
...
def get_detect_model():
    ...
    # Fifth layer
    W_fc2 = weight_variable([2048, 1 + MAX_CHARS * len(common.CHARS)])
    W_conv2 = tf.reshape(W_fc2, [1, 1, 2048, 1 + MAX_CHARS * len(common.CHARS)])
    b_fc2 = bias_variable([1 + MAX_CHARS * len(common.CHARS)])
